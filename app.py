...
st.title("👕 LynchMockup_Tool v4.3 — Copy/Paste + Export")
...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        ...
        with open(f"temp_designs/{design_name}.png", "wb") as f:
        ...
        for garment, config in garments.items():
            ...
            with cols[col_idx]:
                st.markdown(f"*{garment.replace('_', ' ').title()} preview placeholder*")
        ...
        for uploaded_file in uploaded_files:
            ...
            for garment, config in garments.items():
                ...
                for color in config["colors"]:
                    preview_path = f"assets/{garment}/{color}.jpg"
